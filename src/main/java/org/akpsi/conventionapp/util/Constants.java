...
public class Constants {
	...
	public static final String REGISTER_USER = "INSERT INTO `users` (`first_name`,`last_name`,`email`, `salt`, `password`, `phone_number`, `address`, `city`, `state`, `country`,`allowText`,`allowEmail`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
